...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-17 13:03`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8bf9400c-3f82-46b6-898b-ccfdd89a2a1f.git
$ cd 8bf9400c-3f82-46b6-898b-ccfdd89a2a1f
```
